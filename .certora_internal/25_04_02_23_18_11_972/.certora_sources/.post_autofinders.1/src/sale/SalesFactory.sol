...
contract SalesFactory is Ownable {
    ...
    function deploySale() external onlyOwner {
        IceFrogSale sale = new IceFrogSale(i_stakingMining);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001002f,0)}
    ...
    function getAllSales(
        ...
        address[] memory sales = new address[](endIndex - startIndex);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010030,0)}
        uint index = 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000031,index)}

        for (uint256 i = startIndex; i < endIndex; i++) {
            sales[index] = allSales[i];address certora_local50 = sales[index];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000032,certora_local50)}
            index++;
        }
